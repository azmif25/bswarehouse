...
<head>
      <link rel="icon" href="../dekorasi/icon.png">
      <meta charset="utf-8" />
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><?php echo $_SESSION['admin']['nama_lengkap'] ?></a> 
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;"> Time : <span id="time"> </span> &nbsp; <a href="index.php?halaman=logout" class="btn btn-danger square-btn-adjust"><i class="fa fa-sign-out"></i> Logout </a> 
<script>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a href="index.php?halaman=kategori"><i class="fa fa-circle"></i> Kategori </a></li>
