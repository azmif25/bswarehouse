...
<body>
				...
				col-xs-offset-1">
					<div class="panel panel-default">
						<div class="panel-heading text-center">
							<strong> Enter Account To Login </strong>
						</div>
						<div class="panel-body">
							<form role="form" method="post">
								...
								<hr />		
								No Register ? <a href="resgitration.html"> Click here</a>
							</form>
							<?php
	...
	<!-- SCRIPT AT THE BOTTOM TO REDUCE THE LOAD TIME-->
	<!-- JQUERY SCRIPTS -->
